...
exports.register = (cli) => {
    return cli.command('clean', 'Clean all trace and data files', options, (argv) => __awaiter(this, void 0, void 0, function* () {
        //@TODO: this guard might not be necessary
        if (argv.help) {
            return;
        }
        const args = argv_1.sanitize(argv);
        const result = yield puppeteer_1.Puppeteer.clean(args.url, args);
